...
class CustomDatasetFolder(VisionDataset):
    ...
    def __init__(self, root, loader, extensions=None, transform=None, target_transform=None, is_valid_file=None):
        ...
        samples = make_custom_dataset(self.root, 'data/imagenet_test_image_ids.txt',
...
def build_dataset(set_id, transform, data_root, corrupt_type, mode='test', n_shot=None, split="all", bongard_anno=False):
    if set_id == 'imagenet-c':
        testdir = os.path.join(data_root, ID_to_DIRNAME[set_id], corrupt_type, '5')
        testset = CustomImageFolder(testdir, transform)
    elif set_id in ["CIFAR-10-C", "CIFAR-100-C"]:
        testdir = os.path.join(data_root, ID_to_DIRNAME[set_id])
        testset = create_cifarc_dataset(dataset_name=set_id,
                                             severity=5,
                                             data_dir=testdir,
                                             corruption=corrupt_type,
                                             transform=transform)
    else:
